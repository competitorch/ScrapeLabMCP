...
def check_browser_executable() -> Optional[str]:
    ...
    if system == 'windows':
        ...
        possible_paths = [
            # Chrome Canary (preferred: separate app, no conflicts with regular Chrome)
            '/Applications/Google Chrome Canary.app/Contents/MacOS/Google Chrome Canary',
            # Chromium (separate binary, no conflicts)
            '/Applications/Chromium.app/Contents/MacOS/Chromium',
            # Chrome (fallback: may interfere with running Chrome instance)
